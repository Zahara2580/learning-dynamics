...
#SBATCH --job-name="lafand-smoke-nguni-byt5"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/lafand_smoke_nguni-byt5_%j.log
#SBATCH --error=logs/lafand_smoke_nguni-byt5_%j.log
#
# End-to-end smoke test for nguni-byt5 on the lafand pipeline: confirms the
...
#
# Prerequisite (sintx CPU): lafand_preprocess for nguni-byt5 must have made
# /scratch/rmdrak003/data/lafand/nguni-byt5/train.* and dev.*
...
uv run accelerate launch \
    ...
    --n-eval-obs 2000 \
    --log-memory-every 5 \
    --wandb-run-name nguni-byt5-lafand-smoke \
    --metrics-filename metrics_lafand_smoke_nguni-byt5.jsonl \
