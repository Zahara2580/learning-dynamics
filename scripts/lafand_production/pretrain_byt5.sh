...
#SBATCH --job-name="cpt-lafand-byt5"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/lafand_prod_byt5_%j.log
#SBATCH --error=logs/lafand_prod_byt5_%j.log
#
# PRODUCTION lafand-pipeline CPT for byt5: full 10k steps / 5000 warmup /
...
uv run accelerate launch \
    ...
    --eval-steps 200 \
    --n-eval-obs 2000 \
    --wandb-run-name byt5-xho-lafand \
    --metrics-filename metrics_byt5_lafand.jsonl \
