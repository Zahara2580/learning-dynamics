...
#SBATCH --job-name="cpt-batch-byt5-bs16"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/batch_trial_byt5_bs16_%j.log
#SBATCH --error=logs/batch_trial_byt5_bs16_%j.log
#
# Batch size trial for byt5: per_device_batch_size=16,
