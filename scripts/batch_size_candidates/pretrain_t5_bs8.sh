...
#SBATCH --job-name="cpt-t5-bs8"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/pretrain_t5_bs8_%j.log
#SBATCH --error=logs/pretrain_t5_bs8_%j.log
#
# Production batch-size CANDIDATE for t5: per_device_batch_size=8,
...
# each launched as its own real run under run-subdir "t5-xho-bs8" so
