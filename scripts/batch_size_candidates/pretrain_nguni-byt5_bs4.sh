...
#SBATCH --job-name="cpt-nguni-byt5-bs4"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/pretrain_nguni-byt5_bs4_%j.log
#SBATCH --error=logs/pretrain_nguni-byt5_bs4_%j.log
#
# Production batch-size CANDIDATE for nguni-byt5: per_device_batch_size=4,
# gradient_accumulation_steps=256 (effective batch size 1024).
# Real full run (total_steps/warmup_steps from configs/models/nguni-byt5.yaml, no --max-steps
...
#
# Methodology: this is one of several batch-size candidates for nguni-byt5,
# each launched as its own real run under run-subdir "nguni-byt5-xho-bs4" so
...
uv run accelerate launch \
    ...
    --wandb-run-name nguni-byt5-xho-bs4 \
    --metrics-filename metrics_nguni-byt5-xho-bs4.jsonl \
    --run-subdir nguni-byt5-xho-bs4 \
    --eval-steps 200 \
    --save-steps 200 \
    --resume
