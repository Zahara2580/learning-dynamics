...
#SBATCH --job-name="cpt-t5-bs16"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/pretrain_t5_bs16_%j.log
#SBATCH --error=logs/pretrain_t5_bs16_%j.log
#
# Production batch-size CANDIDATE for t5: per_device_batch_size=16,
...
# each launched as its own real run under run-subdir "t5-xho-bs16" so
...
uv run accelerate launch \
    ...
    --metrics-filename metrics_t5-xho-bs16.jsonl \
    --run-subdir t5-xho-bs16 \
    --eval-steps 200 \
    --save-steps 200 \
    --resume
