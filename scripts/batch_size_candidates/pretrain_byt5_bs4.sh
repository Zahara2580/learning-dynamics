...
#SBATCH --job-name="cpt-byt5-bs4"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/pretrain_byt5_bs4_%j.log
#SBATCH --error=logs/pretrain_byt5_bs4_%j.log
#
# Production batch-size CANDIDATE for byt5: per_device_batch_size=4,
...
# each launched as its own real run under run-subdir "byt5-xho-bs4" so
