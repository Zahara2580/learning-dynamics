...
#SBATCH --job-name="cpt-nguni-byt5-bs8"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/pretrain_nguni-byt5_bs8_%j.log
#SBATCH --error=logs/pretrain_nguni-byt5_bs8_%j.log
#
# Production batch-size CANDIDATE for nguni-byt5: per_device_batch_size=8,
...
# each launched as its own real run under run-subdir "nguni-byt5-xho-bs8" so
