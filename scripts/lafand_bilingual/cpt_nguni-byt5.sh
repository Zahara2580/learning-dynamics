...
#SBATCH --job-name="cpt-bil-nguni"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/bilingual_nguni-byt5_%j.log
#SBATCH --error=logs/bilingual_nguni-byt5_%j.log
#
# Phase-2 BILINGUAL CPT for nguni-byt5: same protocol as phase 1 (10k steps,
...
# monolingual run.
#
#   sbatch --export=ALL,CHAIN_JOBS=3 scripts/lafand_bilingual/cpt_nguni-byt5.sh
...
uv run accelerate launch \
    ...
    --data-dir /scratch/rmdrak003/data/lafand-bilingual/nguni-byt5 \
    --batch-size 4 \
    --gradient-accumulation-steps 256 \
    --save-steps 50 \
    --eval-steps 200 \
    --n-eval-obs 2000 \
    --wandb-run-name nguni-byt5-bilingual-lafand \
    --metrics-filename metrics_nguni-byt5_lafand_bilingual.jsonl \
