...
#SBATCH --job-name="cpt-bil-t5"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/bilingual_t5_%j.log
#SBATCH --error=logs/bilingual_t5_%j.log
#
# Phase-2 BILINGUAL CPT for t5: same protocol as phase 1 (10k steps,
...
# monolingual run.
#
#   sbatch --export=ALL,CHAIN_JOBS=3 scripts/lafand_bilingual/cpt_t5.sh
...
uv run accelerate launch \
    ...
    --data-dir /scratch/rmdrak003/data/lafand-bilingual/t5 \
    --batch-size 8 \
    --gradient-accumulation-steps 128 \
    --save-steps 50 \
    --eval-steps 200 \
    --n-eval-obs 2000 \
    --wandb-run-name t5-bilingual-lafand \
    --metrics-filename metrics_t5_lafand_bilingual.jsonl \
