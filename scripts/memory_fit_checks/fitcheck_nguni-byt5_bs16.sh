...
#SBATCH --job-name="cpt-fit-nguni-byt5-bs16"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/memory_fit_nguni-byt5_bs16_%j.log
#SBATCH --error=logs/memory_fit_nguni-byt5_bs16_%j.log
#
# Quick memory-fit check for nguni-byt5: per_device_batch_size=16,
# gradient_accumulation_steps=64 (effective batch size 1024).
# Only 3 steps, purely to check whether bs=16 fits in GPU memory on
...
uv run accelerate launch \
    ...
    --wandb-run-name nguni-byt5-xho-fitcheck-bs16 \
    --metrics-filename metrics_fitcheck_nguni-byt5-bs16.jsonl \
    --run-subdir fitcheck-nguni-byt5-bs16 \
    --no-save
