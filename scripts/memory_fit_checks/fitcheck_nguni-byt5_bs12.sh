...
#SBATCH --job-name="cpt-fit-nguni-byt5-bs12"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/memory_fit_nguni-byt5_bs12_%j.log
#SBATCH --error=logs/memory_fit_nguni-byt5_bs12_%j.log
#
# Quick memory-fit check for nguni-byt5: per_device_batch_size=12,
...
uv run accelerate launch \
    ...
    --wandb-run-name nguni-byt5-xho-fitcheck-bs12 \
    --metrics-filename metrics_fitcheck_nguni-byt5-bs12.jsonl \
    --run-subdir fitcheck-nguni-byt5-bs12 \
    --no-save
