...
#SBATCH --job-name="cpt-fit-nguni-byt5-bs8"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/memory_fit_nguni-byt5_bs8_%j.log
#SBATCH --error=logs/memory_fit_nguni-byt5_bs8_%j.log
#
# Quick memory-fit check for nguni-byt5: per_device_batch_size=8,
# gradient_accumulation_steps=128 (effective batch size 1024).
# Only 3 steps, purely to check whether bs=8 fits in GPU memory on
...
uv run accelerate launch \
    ...
    --wandb-run-name nguni-byt5-xho-fitcheck-bs8 \
    --metrics-filename metrics_fitcheck_nguni-byt5-bs8.jsonl \
    --run-subdir fitcheck-nguni-byt5-bs8 \
    --no-save
