...
#SBATCH --job-name="cpt-lafand-t5-bs4"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/lafand_t5_bs4_%j.log
#SBATCH --error=logs/lafand_t5_bs4_%j.log
#
...
uv run accelerate launch \
    ...
    --eval-steps 200 \
    --n-eval-obs 2000 \
    --wandb-run-name t5-xho-lafand-bs4 \
    --metrics-filename metrics_t5_lafand_bs4.jsonl \
