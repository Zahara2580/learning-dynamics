...
#SBATCH --job-name="cpt-lafand-nguni-byt5-bs4"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/lafand_nguni-byt5_bs4_%j.log
#SBATCH --error=logs/lafand_nguni-byt5_bs4_%j.log
#
# Batch-size CANDIDATE for nguni-byt5 on the lafand pipeline (thesis
...
#
# WINNER (byte-model sweep, decided at step ~1400: eval curves
# indistinguishable from bs8, bs4 ~13% faster). Now runs as 48h links;
# chain to completion with: sbatch --export=ALL,CHAIN_JOBS=2 <this script>
#
