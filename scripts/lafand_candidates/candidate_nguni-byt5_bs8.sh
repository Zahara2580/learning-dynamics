...
#SBATCH --job-name="cpt-lafand-nguni-byt5-bs8"
#SBATCH --mail-user=rmdrak003@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/lafand_nguni-byt5_bs8_%j.log
#SBATCH --error=logs/lafand_nguni-byt5_bs8_%j.log
#
...
uv run accelerate launch \
    ...
    --eval-steps 200 \
    --n-eval-obs 2000 \
    --wandb-run-name nguni-byt5-xho-lafand-bs8 \
    --metrics-filename metrics_nguni-byt5_lafand_bs8.jsonl \
